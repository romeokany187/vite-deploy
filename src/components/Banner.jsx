            ...
            <div className="" style={
                ...
                <div className="w-[55%]">
                    ...
                    <div className="flex gap-6">
                        <div className="">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler p-2 bg-secondary rounded-full icon-tabler-player-play" width="54" height="54" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
